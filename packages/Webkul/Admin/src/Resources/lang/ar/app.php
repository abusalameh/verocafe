...
return [
    ...
    'acl' => [
        ...
        'users' => 'المستخدمين',
        'view' => 'عرض',
        'custom_settings' => 'إعدادات خاصة ب Vero Cafe'
    ],
    ...
    'custom_settings' => [
        'index' => [
            'custom_settings' => [
                'title' => 'إعدادت خاصة ب Vero Cafe',
                'info' => 'جميع الإعدادت الخاصة ب Vero Cafe',
                'special' => [
                    'info' => 'إعدادات مخصصة',
                    'title' => 'إعدادات مخصصة',
                    'prices' => [
                        'title' => 'عرض أسعار المنتجات',
                        'info' => 'عرض أسعار المنتجات لكل زوار الموقع'
                    ],
                    'users' => [
                        'title' => 'تفعيل خاصية تسجيل دخول المستخدمين',
                        'info' => 'السماح لزوار الموقع بإنشاء حسابات خاصة بهم وتسجيل الدخول'
                    ]
                ]
            ],
        ]
