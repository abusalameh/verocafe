...
return [
    ...
    [
        'key' => 'custom_settings',
        'name' => 'admin::app.custom_settings.index.custom_settings.title',
        'info' => 'admin::app.custom_settings.index.custom_settings.info',
        'sort' => 6,
    ],
    [
        'key' => 'custom_settings.special',
        'name' => 'admin::app.custom_settings.index.custom_settings.special.title',
        'info' => 'admin::app.custom_settings.index.custom_settings.special.info',
        'icon' => 'settings/settings.svg',
        'sort' => 1,

    ],
    [
        'key' => 'custom_settings.special.general',
        'name' => 'admin::app.custom_settings.index.custom_settings.special.title',
        'info' => 'admin::app.custom_settings.index.custom_settings.special.title',
        'sort' => 0,
        'fields' => [
            [
                'name' => 'display_prices',
                'title' => 'admin::app.custom_settings.index.custom_settings.special.prices.title',
                'info' => 'admin::app.custom_settings.index.custom_settings.special.prices.info',
                'type' => 'boolean',
                'default' => 0,
            ],
            [
                'name' => 'allow_user_authentication',
                'title' => 'admin::app.custom_settings.index.custom_settings.special.users.title',
                'info' => 'admin::app.custom_settings.index.custom_settings.special.users.info',
                'type' => 'boolean',
                'default' => 0,
            ],
        ],
