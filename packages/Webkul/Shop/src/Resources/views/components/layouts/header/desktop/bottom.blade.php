...
<div class="flex min-h-[78px] bg-[#ebebeb] w-full justify-between border border-b border-l-0 border-r-0 border-t-0 px-[60px] max-1180:px-8">
    <!--
...
@pushOnce('scripts')
    ...
    >
        ...
        >
            <div
                class="group relative text-xs flex h-[77px] items-center border-b-4 border-transparent hover:border-b-4 hover:border-navyBlue"
            ...
            >
                ...
                <div
                    class="pointer-events-none absolute top-[78px] z-[1] max-h-[580px] w-max max-w-[1260px] translate-y-1 overflow-auto overflow-x-auto border border-b-0 border-l-0 border-r-0 border-t border-zinc-300 bg-white opacity-0 shadow-[0_6px_6px_1px_rgba(0,0,0,.3)] transition duration-300 ease-out group-hover:pointer-events-auto group-hover:translate-y-0 group-hover:opacity-100 group-hover:duration-200 group-hover:ease-in ltr:-left-9 rtl:-right-9"
                    ...
                    <div class="aigns flex justify-between gap-x-[70px]">
                        ...
                        >
                            <template v-for="secondLevelCategory in pairCategoryChildren">
                                <p class="font-medium text-navyBlue hover:bg-gray-100 p-4 ">
                                ...
                                >
                                    <li
                                        class="p-4 hover:bg-gray-100 rtl:pr-6 ltr:pl-6 before:content-['-'] before:text-md rtl:before:ml-2 ltr:before:mr-2 text-sm font-medium text-zinc-500"
